...
export function VideoResultModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal - Landscape */}
      <div className="relative z-10 mx-4 w-full max-w-2xl border border-neutral-800 bg-black font-mono text-[14px] tracking-wide uppercase sm:mx-6">
        {/* Header */}
        ...
        <div className="p-4">
          ...
          {/* File Info */}
          <div className="mt-4 flex flex-wrap items-center justify-between gap-2 border border-neutral-800 px-3 py-2">
